      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="top-text header-text">
            <h2>Welcome To Hotel The Paranais</h2>
          </div>
        </div>
        <div class="col-lg-12">
              ...
              <div class="col-lg-3 align-self-center">
                  <fieldset>
                      <select name="area" class="form-select" aria-label="Area" id="chooseCategory" onchange="this.form.click()">
                          ...
                          <option value="Room VVIP">Room VVIP</option>
                      </select>
                  </fieldset>
              </div>
              <div class="col-lg-3 align-self-center">
                      <input type="address" name="address" class="searchText" placeholder="Rate" autocomplete="on" required>
              </div>
              <div class="col-lg-3 align-self-center">
                  <fieldset>
        ...
        <div class="col-lg-10 offset-lg-1">
          <ul class="categories">
            <li><a href="category.html"><span class="icon"><img src="assets/images/Picsart1.png" alt="Home"></span> Room</a></li>
            <li><a href="listing.html"><span class="icon"><img src="assets/images/search-icon-02.png" alt="Food"></span> Food</a></li>
            <li><a href="#"><span class="icon"><img src="assets/images/Picsart.png" alt="Drink"></span> Drink</a></li>
              ...
              <div class="row">
                <div class="col-lg-3">
                  <div class="menu">
                    ...
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="assets/images/Picsart.png" alt=""></span>
                        Drink
                      </div>
                    </div>
                    <div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="contact-us">
            <h4>Contact Us</h4>
            <p>27th Street Hotel The Paranais</p>
            <div class="row">
              <div class="col-lg-6">
